...
class Json2JsonTest {
    ...
    /**
     * Tests the Json2Json parser with a deeply nested JSON structure returning not the deepest object.
     *
     * @throws JSONException if there is an error parsing the JSON.
     */
    @Test
    void testDeeplyNestedJson2JsonParserReturningNonDeepest() throws JSONException {
        String json = "{ \"kopfdaten\": { \"maschine\": \"test\", \"hersteller\": \"vw\", \"details\": { \"baujahr\": 2020, \"modell\": \"golf\", \"spezifikationen\": { \"farbe\": \"rot\", \"ps\": 150 } } }, \"messwerte\": { \"wert1\": \"1test\", \"wert2\": 2, \"wert3\": \"3test\", \"wert4\": 4, \"wert5\": 5, \"wert6\": \"6test\" } }";
    ...
    /**
     * Tests the Json2Json parser with a deeply nested JSON structure returning multiple objects on different levels.
     *
     * @throws JSONException if there is an error parsing the JSON.
     */
    @Test
    void testDeeplyNestedJson2JsonParserReturningMultipleSelections() throws JSONException {
        String json = "{ \"kopfdaten\": { \"maschine\": \"test\", \"hersteller\": \"vw\", \"details\": { \"baujahr\": 2020, \"modell\": \"golf\", \"spezifikationen\": { \"farbe\": \"rot\", \"ps\": 150 } } }, \"messwerte\": { \"wert1\": \"1test\", \"wert2\": 2, \"wert3\": \"3test\", \"wert4\": 4, \"wert5\": 5, \"wert6\": \"6test\" } }";
        ...
        JSONObject expectedMetadata = new JSONObject("{ \"baujahr\": 2020, \"modell\": \"golf\", \"spezifikationen\": { \"farbe\": \"rot\", \"ps\": 150 } }");
        JSONObject expectedData = new JSONObject("{ \"wert1\": \"1test\", \"wert2\": 2, \"wert3\": \"3test\", \"wert4\": 4, \"wert5\": 5, \"wert6\": \"6test\" }");
