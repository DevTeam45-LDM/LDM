...
public class ExperimentTemplateTest {
    ...
    public void testGettersAndSetters() {
        ...
        experimentTemplate.setCategory("Test Category");
        ...
        experimentTemplate.setLocked(false);
        experimentTemplate.setLockedby("User");
        ...
        experimentTemplate.setTeamsId("Team ID");
        experimentTemplate.setIsPinned(true);
        experimentTemplate.setStatus("Status");
        ...
        experimentTemplate.setOrdering(1);
        experimentTemplate.setCanReadTarget(true);
        experimentTemplate.setCanWriteTarget(true);
        experimentTemplate.setContentType("Content Type");
        experimentTemplate.setState("State");
