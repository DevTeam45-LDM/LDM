...
public class ExperimentTemplate {
  ...
  public ExperimentTemplate createdAt(String createdAt) {
  ...
  public ExperimentTemplate modifiedAt(String modifiedAt) {
  ...
  public ExperimentTemplate ordering(String ordering) {
  ...
  public ExperimentTemplate canReadTarget(String canReadTarget) {
    this.canReadTarget = canReadTarget;
    return this;
  }

  @Schema(description = "")
  public String getCanReadTarget() {
    return canReadTarget;
  }

  public void setCanReadTarget(String canReadTarget) {
    this.canReadTarget = canReadTarget;
  }

  public ExperimentTemplate canWriteTarget(String canWriteTarget) {
    this.canWriteTarget = canWriteTarget;
    return this;
  }

  @Schema(description = "")
  public String getCanWriteTarget() {
    return canWriteTarget;
  }

  public void setCanWriteTarget(String canWriteTarget) {
    this.canWriteTarget = canWriteTarget;
  }

  public ExperimentTemplate contentType(Integer contentType) {
  ...
  public ExperimentTemplate state(Integer state) {
    this.state = state;
    return this;
  }
  ...
  public ExperimentTemplate nextStep(String nextStep) {
  ...
  public ExperimentTemplate firstname(String firstname) {
  ...
  public ExperimentTemplate lastname(String lastname) {
  ...
  public ExperimentTemplate orcId(String orcId) {
    this.orcId = orcId;
    return this;
  }
  ...
  public ExperimentTemplate teamName(String teamName) {
  ...
  public ExperimentTemplate upItemId(String upItemId) {
  ...
  public ExperimentTemplate hasAttachment(String hasAttachment) {
