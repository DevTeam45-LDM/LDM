...
public class ExportTemplateController extends TemplateController<ExportTemplate> {
    public ExportTemplateController() throws IOException {
    }

    //use getExportCollection() to get the collection where the template should be

    public void createTemplate(ExportTemplate template) {
