...
// Parser Dropdown
        ...
        headerLayout.add(parserDropdown);

        HorizontalLayout fileExtensionLayout = new HorizontalLayout();
        fileExtensionLayout.setWidthFull();
        fileExtensionLayout.add(fileExtensionField);

        HorizontalLayout formHeader = new HorizontalLayout();
        formHeader.setWidthFull();
        formHeader.add(createLabeledTextField("Skip Line"), new TextField("Metadata"), new TextField("Data"));

        metadataLayout.add(createLabeledTextField("Line Begin"), new TextField(), new TextField());
        metadataLayout.add(createLabeledTextField("Assignments"), new TextField(), new TextField());
        metadataLayout.add(createLabeledTextField("Delimiter"), new TextField(), new TextField());
        metadataLayout.add(createLabeledTextField("Terminator"), new TextField(), new TextField());

        getContent().setWidth("100%");
        getContent().getStyle().set("flex-grow", "1");
        getContent().add(headerLayout, fileExtensionLayout, formHeader, metadataLayout);
    }
