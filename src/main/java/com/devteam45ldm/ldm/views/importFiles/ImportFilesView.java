...
import com.devteam45ldm.ldm.views.filedrop.FileDropView;
...
@Route("importFiles")
@Menu(order = 2, icon = "line-awesome/svg/arrow-alt-circle-down.svg")
public class ImportFilesView extends Composite<VerticalLayout> {
    ...
    public ImportFilesView() {
        ...
        FileDropView dropView = new FileDropView();
        dropView.setWidth("600px");
        dropView.setHeight("80px");
